...
for item_label in index:
    ...
    for item in mouth_list:
        ...
        test_set = pd.read_csv('dataset/2015-06-28_treated.csv', engine='c')
        test_label = pd.read_csv('dataset/2015-06-28_label.csv', engine='c')

        test_set = test_set.iloc[600000:632000, 1:].values
        test_label = test_label.iloc[600000:632000, item_label].values
